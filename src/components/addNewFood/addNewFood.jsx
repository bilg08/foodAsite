...
import { useFoodsAddingContext } from "../../context/foodsAddingContext";
...
export const AddNewFood = (props) => {
  ...
  const [canSaveNewFood, setCanSaveNewFood] = useState({
    isFormFilled: true,
    isFoodImageUploaded: true,
    isIngredientsFilled:true
  })

    

  function FoodFormHeader() {
    return (
